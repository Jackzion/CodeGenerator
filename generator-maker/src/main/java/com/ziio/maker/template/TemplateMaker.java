...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String inputFilePath = "src/com/ziio/acm/MainTemplate.java";
...
//        String searchStr = "Sum: ";
        ...
        long id = makeTemplate(meta, originProjectPath, inputFilePath, modelInfo, searchStr, 1858691755625439232L);
